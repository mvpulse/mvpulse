...
import { LayoutDashboard, History, Gift, Compass, Settings, HelpCircle, ListChecks, Trophy, UserPlus } from "lucide-react";
  ...
  const sidebarSections: SidebarSection[] = [
    {
      ...
      items: [
        ...
        { label: "Referrals", icon: UserPlus, href: "/participant/referrals", dataTour: "sidebar-referrals" },
      ],
    },
    {
      title: "Quick Actions",
